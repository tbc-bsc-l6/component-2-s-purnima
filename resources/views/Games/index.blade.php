    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        ...
        <div class="container mt-2">
            <div class="row">
               ...
               <div class="mb-3">
                    <a class="btn btn-outline-dark" href="{{ route('games.create') }}"> Add New</a>
                </div>
            </div>
        ...
        <div class="container" >
            <div class="row">
                ...
                <div class="col-6 col-md-4 mb-4">
                    <div class="card">
                        <div class="card-body"style="background-color:#80ed99;">
                            <h5 class="card-title"><strong>{{ $game->developer}}</strong></h5>
                            ...
                            <form action="{{ route('games.destroy',$game->id) }}" method="Post">
                                <a class="btn btn-outline-dark float-start" href="{{ route('games.edit',$game->id) }}">Select</a>
                                @csrf
                                @method('DELETE')
